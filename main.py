...
parser.add_argument('-store', '--store', type=str, help='Store variable')
...
if __name__ == "__main__":
    ...
    df = preprocess.Preprocessing(log_name, data, var_list, num_var, obj_var, target=args.target, date_var= args.date, store_var=args.store, unit=args.unit).df
